...
ADJUST_QUANTITIES_GUIDANCE = (
    ...
    "Check that the recipe object is complete with all necessary fields. Ask the the user to provide what is missing."
)
...
TRANSLATE_RECIPE_GUIDANCE = (
    ...
    "Verify that the recipe object is properly structured. Ask the the user to provide what is missing."
)
...
CLARIFY_RECIPE_STEP_GUIDANCE = (
    ...
    "Ensure the recipe object includes all necessary details. Ask the the user to provide what is missing."
)
...
CREATE_RECIPE_FROM_INTENT_GUIDANCE = (
    ...
    "Ask the the user to provide what is missing which is required to create the recipe."
)